...
void test_CSVWriterPerf() {
  ...
  t1 = Time::now();
  std::cout << "10 Row Write: " << std::chrono::duration_cast<std::chrono::nanoseconds>(t1 - t0).count() << " ns\n";
  ...
  t1 = Time::now();
  std::cout << "100 Row Write: " << std::chrono::duration_cast<std::chrono::nanoseconds>(t1 - t0).count() << " ns\n";
  ...
  t1 = Time::now();
  std::cout << "1000 Row Write: " << std::chrono::duration_cast<std::chrono::nanoseconds>(t1 - t0).count() << " ns\n";
  ...
  t1 = Time::now();
  std::cout << "10000 Row Write: " << std::chrono::duration_cast<std::chrono::nanoseconds>(t1 - t0).count() << " ns\n";
  ...
  t1 = Time::now();
  std::cout << "100000 Row Write: " << std::chrono::duration_cast<std::chrono::nanoseconds>(t1 - t0).count() << " ns\n";
  ...
  t1 = Time::now();
  std::cout << "1000000 Row Write: " << std::chrono::duration_cast<std::chrono::nanoseconds>(t1 - t0).count() << " ns\n";
